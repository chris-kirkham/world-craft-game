...
namespace Timeline.Samples
{
    ...
    public class TweenClip : PlayableAsset, ITimelineClipAsset, IPropertyPreview
    {
        ...
        public bool shouldTweenScale = true;
        ...
        public override Playable CreatePlayable(PlayableGraph graph, GameObject owner)
        {
            ...
            tween.startLocalScale = startLocalScale;
            tween.endLocalScale = endLocalScale;
            tween.curve = curve;
        ...
        public void GatherProperties(PlayableDirector director, IPropertyCollector driver)
        {
            ...
            driver.AddFromName<Transform>(kLocalScale + ".x");
            driver.AddFromName<Transform>(kLocalScale + ".y");
            driver.AddFromName<Transform>(kLocalScale + ".z");
        }
    }
}
