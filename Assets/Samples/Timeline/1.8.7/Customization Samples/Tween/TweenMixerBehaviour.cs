    ...
    public class TweenMixerBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                {
                    totalScaleWeight += inputWeight;
                    accumScale = TweenScale(tweenInput, tweenProgress, inputWeight);
                }
            }
            ...
            trackBinding.localScale = new Vector3(
                accumScale.x * m_InitialScale.x,
                accumScale.y * m_InitialScale.y,
                accumScale.z * m_InitialScale.z) /** (1.0f - totalScaleWeight)*/;
        ...
        Vector3 TweenScale(TweenBehaviour tweenInput, float progress, float weight)
        {
